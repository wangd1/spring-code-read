...
public abstract class AnnotationConfigUtils {
	...
	public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
		...
		// 注册ConfigurationClassPostProcessor类型的BeanDefinition，配置类
		...
		// 注册AutowiredAnnotationBeanPostProcessor类型的BeanDefinition，@Autowired、@Value注解的处理器
		...
		// 注册CommonAnnotationBeanPostProcessor类型的BeanDefinition，@Resource注解的处理器
